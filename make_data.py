...
STEPS=['download_election_2022.py','download_boundaries_2022.py','download_demography.py','normalize_data.py','build_crosswalk.py','build_dataset.py','simplify_geometries.py','verify_sample.py','validate_data.py','build_provenance.py']
def main():
