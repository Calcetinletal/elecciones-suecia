...
- Y-axis runs from 0 to 60%, rounded up to the next 5 percentage points with at least 0.5 pp of headroom; no observations are removed. Scales differ between party combinations.
...
The CSV contains exactly the plotted points. `S-2026-Calcetinletal-en-v5-yfit-statistics.json` records definitions, exclusions, sources and the input SHA-256.
