...
The CSV contains exactly the plotted points. `SVG-2026-Calcetinletal-en-v5-yfit-statistics.json` records definitions, exclusions, sources and the input SHA-256.
