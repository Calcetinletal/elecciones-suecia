...
const types={'.svg':'image/svg+xml','.png':'image/png','.html':'text/html; charset=utf-8','.js':'application/javascript','.css':'text/css','.json':'application/json','.gz':'application/gzip','.csv':'text/csv','.md':'text/plain; charset=utf-8'};
