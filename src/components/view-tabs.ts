...
const views = [
 ...
 {id:'demography',label:'Origen de la población',hint:'Ver el origen poblacional y la renta por distrito',icon:'<circle cx="12" cy="12" r="9"/><ellipse cx="12" cy="12" rx="4" ry="9"/><path d="M3 12h18M5 6.5h14M5 17.5h14"/>'},
 {id:'compare',label:'Comparar mapas',hint:'Ver elecciones y población en dos mapas sincronizados',icon:'<rect x="2" y="4" width="8" height="16" rx="1.5"/><rect x="14" y="4" width="8" height="16" rx="1.5"/><path d="m4 16 2-4 2 2m8-5 2 3 2-2"/>'},
] as const;
